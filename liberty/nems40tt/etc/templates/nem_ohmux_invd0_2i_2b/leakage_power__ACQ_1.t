...
$tempAcq setState "S1&!S0&!I0_1&!I1_0&!I1_1&ZN_0&ZN_1&!I0_0"
$tempAcq setStateCoverage "1"

## 
## Wavetable
set tempWT [ SBWaveTable ]
$tempWT setInterface { ZN_1:out ZN_0:out S1 S0 I0_0 I0_1 I1_1 I1_0 } { initial_delay units ct default_slew trailing_delay pp }

$tempWT setStimulus                       {   S1   S0   I0_0 I0_1 I1_1 I1_0 ZN_1 ZN_0  } {
                            "0"   { in0 } {   1    0    0    0    0    0    1    1     }
   "(0)+initial_delay+(1.0*pp)" { start } {   1    0    0    0    0    0    1    1     }
"(0)+initial_delay+(1.0*pp)+pp"   { end } {   1    0    0    0    0    0    1    1     }
}

$tempWT addMeasurements {} {
  { leakage_current      leakage_power { (0)+initial_delay+(1.0*pp) (0)+initial_delay+(1.0*pp)+pp {I0_0 I0_1 I1_0 I1_1 S0 S1} {} } NO_USER SYS }
}

$tempWT bindInterface { ZN_1 ZN_0 S1 S0 I0_0 I0_1 I1_1 I1_0 } { cell_initial_delay None[cycle_time] None[cycle_time] None[default_slew] cell_trailing_delay cell_power_period }
