...
$tempAcq setState "!S0&!I0_0&S1&!I1_0&!Z_0"
$tempAcq setStateCoverage "1"

## 
## Wavetable
set tempWT [ SBWaveTable ]
$tempWT setInterface { Z_0:out S1 S0 I0_0 I1_0 } { initial_delay units ct default_slew trailing_delay pp }

$tempWT setStimulus                       {   S1   S0   I0_0 I1_0 Z_0   } {
                            "0"   { in0 } {   1    0    0    0    0     }
   "(0)+initial_delay+(1.0*pp)" { start } {   1    0    0    0    0     }
"(0)+initial_delay+(1.0*pp)+pp"   { end } {   1    0    0    0    0     }
}
...
$tempWT bindInterface { Z_0 S1 S0 I0_0 I1_0 } { cell_initial_delay None[cycle_time] None[cycle_time] None[default_slew] cell_trailing_delay cell_power_period }
...
$tempTopOp setNodes {Z_0 Z_0[logic_low_name]}
