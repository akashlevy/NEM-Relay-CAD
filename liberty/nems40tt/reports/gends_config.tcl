...
define_parameters -append ioreport {
	...
	"Constraint Pin"
	"Related Pin"
	"Constraint Pin Tin (@@time_unit@@)"
        "Related Pin Tin (@@time_unit@@)"
        "setup (@@time_unit@@)"
        "hold (@@time_unit@@)"
    }
	...
	"Constraint Pin Tin (@@time_unit@@)"
        "Related Pin Tin (@@time_unit@@)"
        "Minimum Pulse Width (@@time_unit@@)"
    }

    set recovery_removal_headers {
        "Constraint Pin"
        "Related Pin"
	"Constraint Pin Tin (@@time_unit@@)"
        "Related Pin Tin (@@time_unit@@)"
...
#
define_parameters -append ioreport {
    set company_name "Company Name Here (set company_name parm)"
}
