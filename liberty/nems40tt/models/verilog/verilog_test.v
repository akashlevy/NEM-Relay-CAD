...
// Host Name: r6cad-tsmc40r.stanford.edu, User Name: akashl, PID: 29848       //
// Directory: /sim/akashl/NEM-Relay-CAD/liberty                               //
//                                                                            //
// File generated on Thu Apr 08 11:41:11 PDT 2021. (SMSC-3)                   //
//****************************************************************************//
...
module nem_ohmux_invd12_2i_8b_test_ZN;

  nem_ohmux_invd12_2i_8b instance0(.S0(S0), .S1(S1));

  nem_ohmux_invd12_2i_8b_stim_ZN instance1(.S0(S0), .S1(S1));

endmodule

module nem_ohmux_invd12_2i_8b_stim_ZN(S0, S1);
  ...
  initial begin
    ...
    begin
      ...
      #20;  
      if(ivector[OUTPUT_ZN_LOCATION] !== ZN && ivector[OUTPUT_ZN_LOCATION] !== 1'bx)
        $display("testbench ERROR : nem_ohmux_invd12_2i_8b:ZN output mismatch at vector no. %d, %b != %b",
                 ctr, ivector[OUTPUT_ZN_LOCATION], ZN);
    end
...
module nem_ohmux_invd12_4i_8b_test_ZN;

  nem_ohmux_invd12_4i_8b instance0(.S0(S0), .S1(S1), .S2(S2), .S3(S3));

  nem_ohmux_invd12_4i_8b_stim_ZN instance1(.S0(S0), .S1(S1), .S2(S2), .S3(S3));

endmodule

module nem_ohmux_invd12_4i_8b_stim_ZN(S0, S1, S2, S3);
  ...
  initial begin
    ...
    begin
      ...
      #20;  
      if(ivector[OUTPUT_ZN_LOCATION] !== ZN && ivector[OUTPUT_ZN_LOCATION] !== 1'bx)
        $display("testbench ERROR : nem_ohmux_invd12_4i_8b:ZN output mismatch at vector no. %d, %b != %b",
                 ctr, ivector[OUTPUT_ZN_LOCATION], ZN);
    end
