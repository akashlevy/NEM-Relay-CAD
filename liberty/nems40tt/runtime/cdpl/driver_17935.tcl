if { [catch {
set_location /miele/users/akashl/NEM-Relay-CAD/liberty/nems40tt
...
set_liberty_attribute -cell nem_ohmux_2i_1b area 0
...
if { [catch {exec mv -f /var/tmp/sis.akashl.[pid].log /miele/users/akashl/NEM-Relay-CAD/liberty/nems40tt/runtime/cdpl/sis.W$::env(CDPL_WORKERID).[get_hostname].[pid].log} mv_err] } {
  log_warning $mv_err
}
set_log_file /miele/users/akashl/NEM-Relay-CAD/liberty/nems40tt/runtime/cdpl/sis.W$::env(CDPL_WORKERID).[get_hostname].[pid].log
exit 0
}
