...
' Content of RF_MEMS_CAPACITOR_DOWN_STATE.vbs. Open-source code covered by BSD license.
' 
' 30th of August, 2011
...
oEditor.CreateBox Array("NAME:BoxParameters", "XPosition:=", "-7.5mm", "YPosition:=",  _
  ...
  "0.0175mm"), Array("NAME:Attributes", "Name:=", "Prepreg1a", "Flags:=", "", "Color:=",  _
  FR4, "Transparency:=", 0, "PartCoordinateSystem:=", "Global", "MaterialName:=",  _
  "FR4_epoxy", "SolveInside:=", true)

oEditor.CreateBox Array("NAME:BoxParameters", "XPosition:=", "-7.5mm", "YPosition:=",  _
  "10mm", "ZPosition:=", "0mm", "XSize:=", "15mm", "YSize:=", "-5.8mm", "ZSize:=",  _
  "0.0175mm"), Array("NAME:Attributes", "Name:=", "Prepreg1b", "Flags:=", "", "Color:=",  _
  FR4, "Transparency:=", 0, "PartCoordinateSystem:=", "Global", "MaterialName:=",  _
  "FR4_epoxy", "SolveInside:=", true)

' ### Prepreg Dielectric ###
oEditor.CreateBox Array("NAME:BoxParameters", "XPosition:=", "-0.75mm", "YPosition:=",  _
  "-5mm", "ZPosition:=", "0.0175mm", "XSize:=", "1.5mm", "YSize:=", "10mm", "ZSize:=",  _
...
oEditor.CreateCylinder Array("NAME:CylinderParameters", "XCenter:=", "0mm", "YCenter:=",  _
  "5mm", "ZCenter:=", "0.0429mm", "Radius:=", "0.75mm", "Height:=", "-0.8557mm", "WhichAxis:=",  _
