...
gate = ep.merge_to_polygon([plate], 0, True, True)[0]
...
layout.write("relay_merged.gds")
layout.write("relay_merged.dxf")
layout.write("relay_merged.cif")
