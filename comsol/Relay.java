...
//     model.component("relay").physics("es").feature("term6").set("TerminalName", "101");
    ...
    model.component("relay").physics("es").feature("term7").set("TerminalName", "102");
